...
const Skill = () => {
  return (
    ...
    >
      ...
      {/* <!-- education content --> */}
      <div className='grid grid-cols-1 md:grid-cols-2 gap-7 hidden'>
        <div className='border p-5 rounded-lg'>
          ...
          <div className='py-6 px-7'>
            ...
            <p>
              ...
              adipisicing elit. Facilis quasi necessitatibus repellendus?
            </p>
          </div>
        </div>
        <div className='border p-5 rounded-lg'>
      ...
      <div className='hidden'>
        <div>
          ...
          <p>
            <span className='text-slate-200 mb-1'>Assalamualikum,</span> <br />{" "}
            I am Rakibul, born and grow at Gazipur in Bangladesh. I am starting
            my education life in my family and enroll a kindergarten
            ...
            and higher studied college in main city area and invest 2 years with
            dedication and hard working, and passed it here 2020. Then, I admit
            a university for higher study in the subject of Management and
            running now.
          </p>
          <p className='mt-3'>
            I am a practicing muslim, follow basic rules of my religious. I woke
            up everyday early in the morning for praying. I am very careful
            about my work. I keep my promise. I am honest in work and stay away
            from lies.
          </p>
        </div>
      </div>
        ...
        <div className='flex flex-wrap justify-center gap-5 my-8'>
          <div className='flex flex-col justify-center parent p-2'>
            <div className='w-24 h-24 rounded-full bg-[#2F3046] mb-2 child'>
              <img className='w-full p-4' src='./assets/tech/html.png' alt='' />
            </div>
            <span className='text-center text-white'>HTML</span>
          </div>
          <div className='flex flex-col justify-center parent p-2'>
            <div className='w-24 h-24 rounded-full bg-[#2F3046] mb-2 child'>
              <img className='w-full p-4' src='./assets/tech/css.png' alt='' />
            </div>
          ...
          <div className='flex flex-col justify-center parent p-2'>
            <div className='w-24 h-24 rounded-full bg-[#2F3046] mb-2 child'>
              <img className='w-full p-4' src='./assets/tech/git.png' alt='' />
            </div>
